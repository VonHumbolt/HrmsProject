...
public class JobExperiencesController {
	...
	@GetMapping("/sortedJobExperiencesByYear")
	public DataResult<List<JobExperience>> sortedJobExperiencesByYear() {
		return this.jobExperienceService.sortedJobExperienceByYear();
	}
